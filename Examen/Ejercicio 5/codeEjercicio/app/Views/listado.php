  ...
  <body>
                ...
                <div class="table table-responsive">
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td> <a href="<?php echo base_url().'/eliminar/'.$cuenta->id ?>" class="btn btn-danger btn-sm">Eliminar</a></td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
                </div>
    ...
    <script type="text/javascript">
        ...
        if(mensaje=='4'){
            ...
            swal(':(','Cuenta no pudo ser eliminada!','error');
        }
    </script>
  </body>
</html>